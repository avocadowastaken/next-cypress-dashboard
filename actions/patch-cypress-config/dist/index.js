...
var require_stringifyString = __commonJS({
  "../../node_modules/yaml/dist/stringify/stringifyString.js"(exports) {
    ...
    var getFoldOptions = /* @__PURE__ */ __name((ctx) => ({
...
var require_addPairToJSMap = __commonJS({
  "../../node_modules/yaml/dist/nodes/addPairToJSMap.js"(exports) {
    ...
    var isMergeKey = /* @__PURE__ */ __name((key) => key === MERGE_KEY || Node.isScalar(key) && key.value === MERGE_KEY && (!key.type || key.type === Scalar.Scalar.PLAIN), "isMergeKey");
...
async function resolveCachePath() {
  ...
  return (0, import_core.group)("Resolving cache path", async () => {
    ...
    await (0, import_exec.exec)("npx", ["cypress", "version", "--component", "binary"], {
      listeners: {
        stdout: (data) => {
          version2 += data.toString("utf8");
        }
      }
    });
    const cachePath = path.join(cacheDir.trim(), version2.trim());
